                ...
                <div class="col-sm-16">
                    <h1>Edit Class</h1>
                        ...
                        <div class="card card-primary card-outline mb-4"> 
                            ...
                            <form action="{{ url('admin/subject/edit/'.$getRecord->id)}}" method="post"> 
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="mb-3"> 
                                    ...
                                    <div class="mb-3"> 
                                        ...
                                        <select name="status" class="form-control">
                                            <option {{ $getRecord->type == 'Sciences' ? 'selected' : '' }} value="0">Sciences</option>
                                            <option {{ $getRecord->type == 'Arts' ? 'selected' : '' }} value="1">Arts</option>
                                        </select>
                                   </div>
                                    <div class="mb-3"> 
